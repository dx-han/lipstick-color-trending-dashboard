...
var rgba = null;
var nearColor = null;
var notNormalGroups = []; // $(document).ready(function () {
...
function page1InitPaletteBackground(hsbRange) {
  ...
  console.log(minMax);
  page1RenderBackground(bgDom, minMax); // $(function() {
...
function page1InitDataPointsOnPalette(hsbRange, colorRawSet) {
  ...
  for (var count = 0; count < colorSplitRawSet.length; ++count) {
    colorInfo = {
      'color': colorSplitRawSet[count].slice(0, 7),
      'name': colorSplitRawSet[count].slice(7)
    };
  ...
  page1RenderDataPoints(colorSet, minMax); // $(function() {
  //     page1AddHsvToColorSet(colorSet);
